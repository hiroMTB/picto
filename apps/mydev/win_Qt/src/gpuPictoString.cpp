...
void gpuPictoString::setup(){
	...
	cout << "loading shader from shaders/posUpdate.frag" << endl;
    updatePos.load("", "shaders/posUpdate.frag");

	cout << "loading shader from shaders/velUpdate.frag" << endl;
	...
	cout << "loading shader from shaders/render.vert, frag, geom" << endl;
